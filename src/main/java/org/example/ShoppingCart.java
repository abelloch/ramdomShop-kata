...
public class ShoppingCart {
    ...
    private BigDecimal calculatePrice(Product product) {
        if (product.getNumberOfLegs() != null) {
            ...
            return methBuyAnimalsByType(product);
            ...
            return methMagicCard(product);
        } else {
            return product.getSellPrice();
        }
    }

    private static BigDecimal methBuyAnimalsByType(Product product) {
    ...
    private static BigDecimal methMagicCard(Product product) {
        return switch (product.getColor()) {
